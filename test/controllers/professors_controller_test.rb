...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { professor_name: @professor.professor_name, professor_sections: @professor.professor_sections } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { professor_name: @professor.professor_name, professor_sections: @professor.professor_sections } }
